...
<script>
  ...
  export default {
    ...
    methods: {
        ...
        setUpDateAndTime() {
            if(this.post && this.post.dateTime) {
                let date = new Date(this.post.dateTime)
                let month = date.getUTCMonth() + 1
                let day = date.getUTCDate()
                let year = date.getUTCFullYear()
                
                this.post.time = date.getHours() + ':' +  date.getMinutes()
                this.post.date = year + "-" + month + "-" + day
            }
        }
    }
  }
